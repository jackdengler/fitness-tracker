(() => {
  ...
  const ingredients = {
    ...
    caesardressing: {
      ...
      sodium: 240,
      fiber: 0,
      other: "Per label: 2 tbsp (30g) = 50 cal, 1g saturated fat, 10mg cholesterol, 2g sugar (0g added), 57mg calcium, 63mg potassium. 12 servings per bottle.",
    },
    groundbeef937: {
    ...
    zaatarmeatballbatch: {
      ...
      fiber: 6.5,
      approx: true,
      other: "Whole batch, homemade — 1 lb Jennie-O 93/7 turkey (680 cal), 2 Tbsp tahini (180), ½ cup TJ's panko (130), 150g Greek yogurt (80), 1 large egg (72), 2 Tbsp za'atar (45), lemon/parsley/garlic (16), 1 tsp kosher salt (1,120mg sodium). Edit the qty for the fraction of the batch you ate: 0.5 is half, 0.25 is the quarter-batch serving.",
    },
    greekpita: {
      name: "Greek pita",
      serving: "1 pita",
  ...
  const meals = [
    ...
    },
    {
      ...
      serving: "170g chicken, 1 cup broccoli slaw, honey mustard dressing",
      calories: 408,
      protein: 35.1,
      carbs: 36.1,
      fat: 13,
      ...
      fiber: 3.5,
      approx: true,
      note: "The chicken honey mustard wrap as a salad — broccoli slaw is the base instead of lettuce leaves. Slaw defaults to 1 cup (85g); edit its qty in cups. Chicken is a per-gram ingredient — edit its qty to the exact grams you used and the total recalculates. Default here is 170g (~6 oz, 2 tenders).",
    ...
    {
      id: "zaatar-turkey-meatballs-pita",
      name: "Za'atar Turkey Meatballs with Pita",
      serving: "½ batch (~9–10 meatballs) + 1.5 pita",
      calories: 901.5,
      protein: 71,
      carbs: 82.5,
      fat: 33.25,
      ...
      fiber: 10.75,
      approx: true,
      note: "Half the batch at a time with 1.5 pita — the batch of 19 meatballs plus sauce is two of these. Both parts are qty-adjustable: set the batch to 0.25 for the quarter-batch serving (301 cal on its own), or change the pita count. Homemade, so the ingredient values are estimates.",
      ingredientIds: [["zaatarmeatballbatch", 0.5], ["greekpita", 1.5]],
    },
    {
      ...
      fiber: 12,
      approx: true,
      note: "Restaurant item, estimated. 18g of the 50g fat is saturated (not tracked separately). Tortilla, carnitas, cheese, crema, beans, rice, white onion, lime juice — switch any of them off after logging. The eight together are exactly the 1,165 cal whole-burrito estimate; how it divides between them is still an estimate, so correct a part's qty if you know better.",
      ingredientIds: ["flourtortilla12", "carnitas6oz", "shreddedcheese", "crema2tbsp", "pintobeans", "mexicanrice", "whiteonionquartercup", "limejuice"],
    },
    {
