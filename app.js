  ...
  const meals = [
    {
      id: "two-fried-eggs",
      name: "Two Fried Eggs",
      serving: "2 eggs fried in a drizzle of olive oil",
      calories: 180,
      protein: 12,
      carbs: 0,
      fat: 14.5,
      ...
      fiber: 0,
      approx: true,
      note: "Egg values per carton label (1 egg = 70 cal, 185mg cholesterol). Olive oil is a ~1 tsp pan-drizzle estimate — adjust its qty if you use more or less.",
      ingredientIds: ["egg", "egg", "oliveoildrizzle"],
    },
    {
    ...
    },
    {
      ...
      fiber: 5.1,
      approx: true,
      note: "Totals are the exact sum of the 13 listed ingredients.",
      ingredientIds: [
        "groundbeef937",
        "avocadooilspray",
        "garlic",
